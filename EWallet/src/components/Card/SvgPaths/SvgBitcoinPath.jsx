...
function SvgBitcoinPath({formData, isActive}){
...
const handleCardClick = () => {
    ...
    return (
        ...
        <div className={isActive ? "active-card" : "shape"} onClick={handleCardClick} style={{backgroundColor: "#FFAE34", color: "#333333", marginTop:"10px"}}>
