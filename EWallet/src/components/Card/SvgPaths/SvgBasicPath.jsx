...
function SvgBasicPath({ formData,handleCardClick }) {
    /*const { cardHolderName, cardNumber,  validDates , vendor} = formData || {};
...
/*const handleCardClick = (cardData, vendor) => {
    ...
    console.log("basic", vendor);
};*/

/*const handleClick = () => {
    handleCardClick();
    dispatch(setActiveCard(formData));
    console.log("its the click on basic svg", formData);
...
/*<div className="shape" onClick={handleClick}>
    <div className='card-details'>
        <div className='name-number'>
            <p className="number"> 
            {formData.cardNumber} </p>
            <p>CARDHOLDER</p>
            <p className="name" > 
            {formData.cardHolderName}</p>
        </div>
